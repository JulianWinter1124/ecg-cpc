...
class DownstreamLinearNet(nn.Module):
    ...
    def __init__(self, cpc_model_trained, timesteps_in, context_size, latent_size, out_classes, use_context=False,
                 use_latents=True):
        super().__init__()
        ...
        if self.use_context and self.use_latents:
            self.linear = nn.Linear(in_features=latent_size + context_size,
                                    out_features=out_classes)  # TODO: this is broken
