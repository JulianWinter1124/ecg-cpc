...
class BaselineNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, out_classes, verbose):
        ...
        self.convs = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool1d(3),
            nn.Conv1d(in_channels=out_channels, out_channels=out_channels, kernel_size=3, dilation=1),
            nn.BatchNorm1d(out_channels),
            nn.ReLU(),
            nn.MaxPool1d(3),
            nn.Conv1d(in_channels=out_channels, out_channels=out_channels, kernel_size=3, dilation=1),
        ...
        self.downsample = nn.Conv1d(in_channels=348, out_channels=1, kernel_size=1)
