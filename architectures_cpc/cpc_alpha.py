...
class CPC(nn.Module):
    ...
    def __init__(self, encoder, autoregressive, predictor, timesteps_in, timesteps_out, latent_size, alpha=1.0, timesteps_ignore=0, normalize_latents=False, verbose=False, sampling_mode='same'):
        super().__init__()
