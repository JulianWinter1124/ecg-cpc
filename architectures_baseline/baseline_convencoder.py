...
class BaselineNet(nn.Module):
    ...
    def __init__(self, in_channels, latent_size, out_classes):
        ...
        self.t_convs = nn.Sequential(
            nn.ConvTranspose1d(in_channels=latent_size, out_channels=latent_size, kernel_size=2, stride=1,
                               output_padding=0),
            nn.BatchNorm1d(latent_size),
            nn.ReLU(),
            nn.ConvTranspose1d(in_channels=latent_size, out_channels=latent_size, kernel_size=3, stride=2,
                               output_padding=1),
            nn.BatchNorm1d(latent_size),
            nn.ReLU(),
            nn.ConvTranspose1d(in_channels=latent_size, out_channels=latent_size, kernel_size=3, stride=2,
            ...
            nn.BatchNorm1d(latent_size),
            nn.ReLU(),
            nn.ConvTranspose1d(in_channels=latent_size, out_channels=latent_size, kernel_size=4, stride=3,
                               output_padding=0),
            nn.BatchNorm1d(latent_size),
            nn.ReLU(),
            nn.ConvTranspose1d(in_channels=latent_size, out_channels=in_channels, kernel_size=5, stride=4,
                               output_padding=3),
