...
def create_timeseries_image():
    ...
    georgia_challenge = ecg_datasets2.ECGChallengeDatasetBaseline('/media/julian/data/data/ECG/georgia_challenge/',
                                                        window_size=crop_size, pad_to_size=crop_size, return_labels=True, return_filename=True,
    ...
    cpsc2_challenge = ecg_datasets2.ECGChallengeDatasetBaseline('/media/julian/data/data/ECG/china_challenge', window_size=crop_size,
                                                     pad_to_size=crop_size, return_labels=True, return_filename=True,
                                                        normalize_fn=ecg_datasets2.normalize_feature_scaling)
    ...
    for data, labels, filenames in dl:
        ...
        timeseries_to_image(data, grad=None, pred_classes=None, ground_truth=[ground_truth], save=True, show=True, downsample_factor=1, filename=f'/home/julian/Downloads/Github/contrastive-predictive-coding/images/data_visualization/{fname}')
