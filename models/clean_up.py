...
if __name__ == '__main__':
    ...
    print('low_label',filter_folders_universal(
        ...
        file_content_filter_fnlist_dict={
            ...
            'params.txt':[
                lambda x: not 'train-test-splits.txt' in x
            ]
        },
        file_filter_fnlist=[
    ...
    print('normal cpc',filter_folders_universal(
        folders=filter_folders_age(newer_than=1638140400), #CPC and tested
        file_content_filter_fnlist_dict={
            'model_variables.txt':[
                lambda x: "architectures_cpc.cpc_combined.CPCCombined" in x,
                ...
                lambda x: "cpc_predictor_v0" in x,
                lambda x: '"normalize_latents": false' in x,
                lambda x: not 'crossentropy' in x
            ],
            'params.txt':[
        ...
        file_filter_fnlist=[
            lambda f: not ('labels-dataloader-0.csv' in f),
            lambda fs: not any(['checkpoint_epoch_20.pt' in f for f in fs]),
            lambda fs: any(['checkpoint_epoch_100.pt' in f for f in fs])
        ]))
    ...
    print(filter_folders_universal(
        ...
        file_content_filter_fnlist_dict={
            ...
            'params.txt':[
                lambda x: 'train-test-splits.txt' in x,
                lambda x: not "pretrain_epochs=0" in x
            ]
        },
        file_filter_fnlist=[
            lambda f: not ('labels-dataloader-0.csv' in f),
    ...
    #     file_filter_fnlist=[
    #         lambda f: not ('labels-dataloader-0.csv' in f),
    #         lambda fs: any(['checkpoint_epoch_120.pt' in f for f in fs])
    #     ]))

    # print('v0', filter_folders_universal(
    #     folders=filter_folders_age(newer_than=1638140400), #CPC and tested
    #     file_content_filter_fnlist_dict={
    #         'model_variables.txt':[
    #             lambda x: "architectures_cpc.cpc_combined.CPCCombined" in x,
    ...
    #         lambda fs: any(['checkpoint_epoch_100.pt' in f for f in fs])
    #     ]))
    # print('v0-nocontext', filter_folders_universal(
    #     folders=filter_folders_age(newer_than=1638140400), #CPC and tested
    #     file_content_filter_fnlist_dict={
    #         'model_variables.txt':[
    #             lambda x: "architectures_cpc.cpc_combined.CPCCombined" in x,
    #             lambda x: "cpc_encoder_v0" in x,
    #             lambda x: "cpc_predictor_nocontext" in x,
    #             lambda x: '"normalize_latents": false' in x,
    #             lambda x: 'cpc_intersect_manylatents' in x,
    #             lambda x: '"latent_size": 128,' in x,
    #             lambda x: '"timesteps_in": 12,' in x,
    ...
    #         lambda fs: any(['checkpoint_epoch_100.pt' in f for f in fs])
    #     ]))
    # print('v8-nocontext', filter_folders_universal(
    #     folders=filter_folders_age(newer_than=1638140400), #CPC and tested
    #     file_content_filter_fnlist_dict={
    #         'model_variables.txt':[
    #             lambda x: "architectures_cpc.cpc_combined.CPCCombined" in x,
