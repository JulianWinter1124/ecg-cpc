...
class Encoder(nn.Module):
    def __init__(self, channels, latent_size):
        ...
        filters = [8, 6, 5, 4, 3]#, (8,1), (4,1), (4,1), (4,1)]  # See https://arxiv.org/pdf/1807.03748.pdf#Audio
        ...
        self.convolutionals = nn.Sequential(
            *[e for t in [
                (nn.Conv1d(in_channels=n_channels[i], out_channels=n_channels[i + 1], kernel_size=filters[i], dilation=dilations[i], stride=strides[i], padding=0),
                 (nn.ReLU())
